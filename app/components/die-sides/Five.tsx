export default function Five() {
  return (
    <div className="">
      <div className="outline outline-2 h-36 w-36 bg-gray-200 rounded-2xl shadow-2xl transform rotate-2 p-4 hover:scale-150 transition duration-700 hover:rotate-180 hover:shadow-2xl">

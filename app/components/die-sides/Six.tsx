...
export default function Six({ className = "" }) {
  return (
    <div className={`${className}`}>
      ...
      >
        ...
        <div className="absolute w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 bg-black rounded-full top-1/2 left-3 transform -translate-y-1/2"></div>
        <div className="absolute w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 bg-black rounded-full top-1/2 right-3 transform -translate-y-1/2"></div>
      </div>
    </div>
  );
}
